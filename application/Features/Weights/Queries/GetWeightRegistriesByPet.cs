...
public class GetWeightRegistriesByPet
{
    ...
    public class GetWeightRegistriesByPetHandler(ApiDbContext context, IMapper mapper) : IRequestHandler<GetWeightRegistriesByPetQuery, IEnumerable<GetWeightRegistriesByPetResponse>>
    {
